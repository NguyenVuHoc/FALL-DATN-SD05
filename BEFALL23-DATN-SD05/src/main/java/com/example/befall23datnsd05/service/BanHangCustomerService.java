...
public interface BanHangCustomerService {
    ...
    void datHangItems(GioHangWrapper gioHangWrapper, String ten, String diaChi, String sdt, String ghiChu, BigDecimal shippingFee, BigDecimal totalAmount, Long selectedVoucherId, Integer diemTichLuyApDung, Integer diemTichLuy, String useAll);
